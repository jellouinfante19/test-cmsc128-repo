...
<div class="row">
	<div  id="sidebar" class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
			...
			<div class="sidebar-box-sm" onclick="showhide('#c8')">
					<div class="glyphicon glyphicon-list"></div>
					 <div class="text">Show Subjects</div>
			</div>
			
			<div class="sidebar-box-sm" onclick="showhide('#c9')">
				<div class="glyphicon glyphicon-plus"></div>
				 <div class="text">Add Student to Section</div>
			</div>
			...
			<table>
				...
				@foreach($subject as $s)
					<tr>
						...
						<td>{{$s->Title}}</td>
						<td>{{$s->Semester_offered}}</td>
						<td>{{$s->Grade_level}}</td>
					</tr>
				@endforeach
			</table>
		</div>
		<div id="c9" class="content">
			<h2>Add Student to Section</h2>
			<center>
			{{ Form::open(array('route'=>'add_student')) }}
			<table>
				<tr>
					<td>{{ Form::label('Student_Number', 'Student Number')}}</td>
					<td>{{ Form::text('Student_Number') }}</td>
				</tr>
				<tr>
					<td>{{ Form::label('Year_Level', 'Year Level') }}</td>
					<td>{{ Form::text('Year_Level') }}</td>
				</tr>
				<tr>
					<td>{{ Form::label('Section', 'Section') }}</td>
					<td>{{ Form::text('Section') }}</td>
				</tr>
				<!--<tr>
					<td>{{ Form::label('School_Year', 'School Year') }}</td>
					<td>{{ Form::text('School_Year') }}</td>
				<tr>-->
